							...
							<div class="panel">
								...
								<div class="panel-body no-padding">
									<table class="table table-striped">
										...
										<tbody>
                        """),_display_(Seq[Any](/*289.26*/for(bill <- Bill.findAll()) yield /*289.53*/{_display_(Seq[Any](format.raw/*289.54*/("""
                          <tr>
                            <td>"""),_display_(Seq[Any](/*291.34*/Commodity/*291.43*/.get_store(bill.commodityId).storename)),format.raw/*291.81*/("""</td>
                            <td><a href="#">"""),_display_(Seq[Any](/*292.46*/Commodity/*292.55*/.findById(bill.commodityId).commodityName)),format.raw/*292.96*/("""</a></td>
                            <td>"""),_display_(Seq[Any](/*293.34*/bill/*293.38*/.money)),format.raw/*293.44*/("""</td>
                            <td>"""),_display_(Seq[Any](/*294.34*/Commodity/*294.43*/.get_store(bill.commodityId).user)),format.raw/*294.76*/("""</td>
                            <td>"""),_display_(Seq[Any](/*295.34*/bill/*295.38*/.user)),format.raw/*295.43*/("""</td>
                          </tr>
                        """)))})),format.raw/*297.26*/("""
